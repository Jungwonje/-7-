...
public class RentEarphoneActivity extends AppCompatActivity {
    private RentManager rentManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rent_earphone);
        ...
        btnConfirmRental.setOnClickListener(v -> {
            ...
            int availableQuantity = rentManager.getItemCount("이어폰");
            ...
            for (int i = 0; i < rentalQuantity; i++) {
                rentManager.rentItem("이어폰", rentalDate); // 대여 날짜 전달
            }

            Intent resultIntent = new Intent();
            resultIntent.putExtra("itemName", "이어폰");
