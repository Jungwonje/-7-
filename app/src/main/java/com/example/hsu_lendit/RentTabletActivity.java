...
public class RentTabletActivity extends AppCompatActivity {
    private RentManager rentManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rent_tablet);
        ...
        btnConfirmRental.setOnClickListener(v -> {
            ...
            int availableQuantity = rentManager.getItemCount("태블릿");
            ...
            for (int i = 0; i < rentalQuantity; i++) {
                rentManager.rentItem("태블릿", rentalDate);
            }

            Intent resultIntent = new Intent();
            resultIntent.putExtra("itemName", "태블릿");
