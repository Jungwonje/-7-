...
public class RentMouseActivity extends AppCompatActivity {
    private RentManager rentManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_rent_mouse);
        ...
        btnConfirmRental.setOnClickListener(v -> {
            ...
            int availableQuantity = rentManager.getItemCount("마우스");
            ...
            for (int i = 0; i < rentalQuantity; i++) {
                rentManager.rentItem("마우스", rentalDate); // 대여 날짜 전달
            }

            Intent resultIntent = new Intent();
            resultIntent.putExtra("itemName", "마우스");
